...
use Nwidart\Modules\Commands\Make\EventProviderMakeCommand;
...
return [
    ...
    */
    'stubs' => [
        ...
        'files' => [
            'appmenulistener' => 'app/Listeners/AppMenuListener.php',
        ...
        'replacements' => [
            ...
            'appmenulistener' => ['LOWER_NAME', 'STUDLY_NAME', 'MODULE_NAMESPACE'],
            'event-provider' => ['LOWER_NAME', 'STUDLY_NAME', 'CLASS_NAMESPACE', 'MODULE_NAMESPACE'],
            'routes/api' => ['LOWER_NAME', 'STUDLY_NAME', 'MODULE_NAMESPACE', 'PROVIDER_NAMESPACE', 'CONTROLLER_NAMESPACE'],
