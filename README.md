...
![Issues](https://img.shields.io/github/issues/arthanush/hr-management)
![Forks](https://img.shields.io/github/forks/arthanush/hr-management)
![Stars](https://img.shields.io/github/stars/arthanush/hr-management)
...
git clone https://github.com/arthanush/laravel-CIHR.git CIHR
```
```
cd CIHR
...
- Admin
```
 email: superadmin@cihr.com
 password: password
```

- Employee
```
 email: employee@cihr.com
 password: password
```

- Client
```
 email: client@cihr.com
 password: password
```
...
##### Please note that, this project is under active development so few things might break when you update. You can report any of your issues [here](https://github.com/arthanush/Laravel-CIHR/issues)

Consider supporting the project if you finds it helpful. Thank you
- [Paystack](https://paystack.com/pay/arthanush)
- [Paypal](https://www.paypal.com/paypalme/arthanush)
- [Patreon](https://www.patreon.com/arthanush)
...
![Projects](screenshots/projects-grid.png?raw=true "Projects View")
![Payslip](screenshots/payslip.png?raw=true "Payslip")
![Chat App](screenshots/chat-app.png?raw=true "Chat")
